...
Sondereinheit zu Semesterbeginn im **INFI-Unterricht** (beide Gruppen gemeinsam),
SJ 2026/27. Agentic Coding hat hier bewusst **Vorrang vor SQL-Detailtiefe**: Der
Umgang mit Coding-Agenten ist in der Berufswelt heute Grundwerkzeug.
...
2. **Offene Werkstatt (~60')** – jede/r arbeitet im eigenen Tempo an den
   **Checkpoints**; die Lehrperson geht herum und supportet:
   ...
   - **Checkpoint 3 – Agent-Loop:** im eigenen Repo `/init` → `AGENTS.md` prüfen;
     im Beispiel aus Jg II
     [`../../ARCHIV/2025-26-2ahwii/2025-09-25_sqlite_mit_deno/main.ts`](../../ARCHIV/2025-26-2ahwii/2025-09-25_sqlite_mit_deno/main.ts)
     erklären, verbessern, ausführen lassen (Plan-/Build-Modus, `@`-Datei, `/undo`).
...
- **`@`-Datei**: Kontext gezielt geben, z. B.
  `erkläre @ARCHIV/2025-26-2ahwii/2025-09-25_sqlite_mit_deno/main.ts`.
