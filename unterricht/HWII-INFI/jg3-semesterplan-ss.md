...
**KM-Steckbrief:** `../../lehrplan/infi-hwii/kompetenzmodule/km6.md` · **Verbund mit SWP:** `../../lehrplan/infi-hwii/3HWII/README.md`
...
> (CLI/TUI), Reportgenerierung — siehe unten und `../../lehrplan/infi-hwii/3HWII/README.md` → Kollegen-Soll.
...
> Details und Rubriken: `../../lehrplan/infi-hwii/3HWII/README.md`.
...
- Absprache und Verteilung (wöchentlich/geblockt): `../../lehrplan/infi-hwii/3HWII/README.md` → Offene Punkte.
