...
| # | Themenvorschlag | Lehrplan-Bezug | Inhalt/HÜ |
|---|------------------|-----------------|-----------|
| 9.1 | Entscheidungsunterstützungssysteme – Überblick | Informationssysteme (Einsatzbereiche) | _tbd_ |
| 9.2 | Datawarehouse – Konzept & Architektur | Datawarehouse | _tbd_ |
| 9.3 | OLTP vs. OLAP, Sterne/Schneeflocke | Datawarehouse | _tbd_ |
| 9.4 | Datamining: Assoziation, Klassifikation, Clustering | Datamining | _tbd_ |
| 9.5 | KI-Systeme im Überblick (Experten-/Fuzzy/ML) | KI-Systeme | _tbd_ |
| 9.6 | Betriebsdatenerfassung (Geräte, Funktion) | Betriebsdatenerfassung | _tbd_ |
| 9.7 | Workflows firmenintern & extern (Kunden/Lieferanten) | Datenmodelle/Workflows | _tbd_ |
| 9.8 | Elektronischer Zahlungsverkehr (Methoden, Sicherheit) | elektronischer Zahlungsverkehr | _tbd_ |
| 9.9 | ERP Vertrieb I (Vertriebsprozess, Kundenstammdaten, Preise) | ERP Vertrieb | _tbd_ |
| 9.10 | ERP Vertrieb II (Anfrage→Angebot→Auftrag→Kommissionierung) | ERP Vertrieb | _tbd_ |
| 9.11 | ERP Vertrieb III (Faktura, Zahlungseingang) | ERP Vertrieb | _tbd_ |
| 9.12 | Zusammenfassung / PLF-Vorbereitung | KM9 Schau | _tbd_ |
...
| # | Themenvorschlag | Lehrplan-Bezug | Inhalt/HÜ |
|---|------------------|-----------------|-----------|
| 10.1 | Geschäftsprozessmodellierung: Notationen (BPMN/EPC) | Modellierungswerkzeuge | _tbd_ |
| 10.2 | Aufbau eines Prozessmodells | Modellbildung (Aufbau) | _tbd_ |
| 10.3 | Simulation eines Modells | Simulation | _tbd_ |
| 10.4 | Analyse & Schwachstellen | Analyse eines Modells | _tbd_ |
| 10.5 | Kostenrechnung I: Kostenarten & Kostenstellen | Kostenrechnung | _tbd_ |
| 10.6 | Innerbetriebliche Leistungsverrechnung | innerbetriebliche Leistungsverrechnung | _tbd_ |
| 10.7 | Stundensätze (Personal/Maschine) | Personal-/Maschinenstundensätze | _tbd_ |
| 10.8 | Produktkostenkalkulation | Produktkostenkalkulation | _tbd_ |
| 10.9 | Durchlaufzeit-/Kostenreduktion aus Simulation | ERP-Auftragssimulation | _tbd_ |
| 10.10 | Auswertungen & Analysen | Auswertungen | _tbd_ |
| 10.11 | Diplomarbeits-/Projektbezug | Übergang DA | _tbd_ |
| 10.12 | Maturavorbereitung / Repetition | KM9 Schau | _tbd_ |
...
3. Verfügbare **BI-/DWH-Werkzeuge** an der Schule (Excel PowerPivot? Tableau? Eine SAP-BW-Übungsumgebung?).
4. Wochenstunden 4 → **~12 Einheiten/Semester** realistisch? (Im Maturajahr bleiben netto eher weniger.)

> Siehe auch: 4. Klasse `jg4-einheiten.md` für ERP-Basics (Vertrieb/Kostenrechnung baut dortigem Material auf).