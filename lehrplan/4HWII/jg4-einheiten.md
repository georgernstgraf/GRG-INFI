...
|---|------------------|-----------------|-----------|
| 7.1 | Einführung ERP: Was ist ein ERP? Anbieter, Module | ERP-Systeme | _tbd_ |
| 7.2 | Aufbau/Navigation im Schul-ERP-System | Benutzeroberfläche | _tbd_ |
| 7.3 | Organisationseinheiten (Buchkreis, Werk, Lager) | Organisationseinheiten | _tbd_ |
| 7.4 | Finanzbuchhaltung I: Konten & Kontenplan | Finanzbuchhaltung | _tbd_ |
| 7.5 | Finanzbuchhaltung II: Buchungssätze (Soll/Haben) | Buchungen | _tbd_ |
| 7.6 | Kreditoren- und Debitorenbuchhaltung | Kreditoren-/Debitorenbuchhaltung | _tbd_ |
| 7.7 | Einfacher Geschäftsfall verbuchen | „einfache Geschäftsfälle verbuchen" | _tbd_ |
| 7.8 | Reports & Auswertungen I | Reports | _tbd_ |
| 7.9 | Bilanz & GuV-Rechnung | Bilanz und GuV | _tbd_ |
| 7.10 | Auswertungen & Analysen II | Auswertungen | _tbd_ |
| 7.11 | Zusammenfassung / Übungsfall | KM7 Gesamtschau | _tbd_ |
| 7.12 | PLF / Mock-PLF ERP-Basics | KM7 | _tbd_ |
...
| # | Themenvorschlag | Lehrplan-Bezug | Inhalt/HÜ |
|---|------------------|-----------------|-----------|
| 8.1 | Materialstammdaten anlegen | Materialstammdaten | _tbd_ |
| 8.2 | Lieferantenstammdaten | Lieferantenstammdaten | _tbd_ |
| 8.3 | Beschaffungsprozess I (Bedarf, Bestellung) | Bedarfsermittlung, Bestellung | _tbd_ |
| 8.4 | Beschaffungsprozess II (Wareneingang, Rechnungsprüfung, Zahlung) | Wareneingang, Rechnungsprüfung, Zahlungsausgang | _tbd_ |
| 8.5 | Produktionsplanung I: Bedarfsplanung, Dispositionsarten | Bedarfsplanung, Dispositionsarten | _tbd_ |
| 8.6 | Erzeugnisgliederung & Stücklisten | Erzeugnisgliederung, Stücklisten | _tbd_ |
| 8.7 | Arbeitsplatzstammdaten & Arbeitsplan | Arbeitsplatzstammdaten, Arbeitsplan | _tbd_ |
| 8.8 | Terminierung & Durchlaufzeitreduzierung | Terminierung, Strategien | _tbd_ |
| 8.9 | Kalkulation (Vor-/Nach) & Aufträge (Plan/Fertigung) | Vorkalkulation, Planauftrag, Fertigungsauftrag | _tbd_ |
| 8.10 | Betriebsdatenerfassung & Rückmeldungen | Betriebsdatenerfassung, Rückmeldungen | _tbd_ |
| 8.11 | Auswertungen & Analysen | Auswertungen | _tbd_ |
| 8.12 | PLF / große Übungsfälle Beschaffung+Produktion | KM8 Gesamtschau | _tbd_ |
...
3. Wochenstunden Jg IV = 2 → **~12 Einheiten/Semester** bestätigen.

> Siehe auch: 5. Klasse `jg5-einheiten.md` (KM9 enthält neben Informationssystemen *auch* ERP-Vertrieb und Kostenrechnung – dortige ERP-Planung balanceiert mit Jg IV ab).